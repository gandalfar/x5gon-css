...
<p class="lead">Below you can find the different colors that work well with the color pallet of the project.</p>
...
<div class="row up-1 medium-up-3 large-up-5">
  <div class="column">
    <div class="color-block">
      <span style="background: #5B95A5"></span>
      #5B95A5
    </div>
  </div>
  <div class="column">
...
<p class="lead">This design uses <a href="https://fonts.google.com/specimen/Open+Sans">Open Sans</a> for headings and paragraph text.</p>
